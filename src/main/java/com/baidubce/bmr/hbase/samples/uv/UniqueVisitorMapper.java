...
/**
 * Mapper class for UniqueVisitor.
 * 
 */
public class UniqueVisitorMapper extends TableMapper<Text, Text> {
  ...
  protected void map(ImmutableBytesWritable rowKey, Result result, Context context)
    ...
    byte[] remoteAddr = result.getValue(TableInfo.COLUMN_FAMILY, TableInfo.COLUMN_REMOTE_ADDR);
    byte[] timeLocal = result.getValue(TableInfo.COLUMN_FAMILY, TableInfo.COLUMN_TIME_LOCAL);
    String ipStr = new String(remoteAddr);
